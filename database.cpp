...
DataBase::DataBase()
{
    ...
    {
        //1.加载数据库驱动
        db_ = QSqlDatabase::addDatabase("QMYSQL", "testConnection");
        db_.setHostName("fe80::f97d:b1b6:55b1:194%3");
        db_.setUserName("root");
        db_.setPassword("516898");

//        db_ = QSqlDatabase::addDatabase("QMYSQL", "testConnection");

//        db_.setHostName("2001:da8:270:2021::f9");
//        db_.setUserName("ipv6");
//        db_.setPassword("123456");
        ...
        //2.设置数据库名
        db_.setDatabaseName("info");
//        db_.setDatabaseName("csu_csrw");
